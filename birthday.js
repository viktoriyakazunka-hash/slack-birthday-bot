...
const messages = [
  "🎉 Ура! Сегодня день рождения у {USERS} — давайте поздравим и пожелаем отличного настроения и большого счастья!",
  "🎂 Сегодня праздник у {USERS}! Желаем радости, улыбок и классного года впереди!",
